...
# order matters here:
SMLFILES=DateUtil.sml ListSort.sig ListSort.sml CURRENCY.sig Currency.sml ContractBase.sml ContractTransform.sml CONTRACT.sig Contract.sml Instruments.sml test.sml

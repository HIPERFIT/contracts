...
val tests1 = [ ("add nothing", (?"2013-01-01"), (addDays 0 today))
             , ("add one day", (?"2013-01-02"), (addDays 1 today))
             , ("add one (non-leap) year", (?"2014-01-01"), (addDays 365 today))
             , ("add January", (?"2013-02-01"), (addDays 31 today))
             , ("add first 6 months of the year", 
                (?"2013-07-01"), (addDays (31+28+31+30+31+30) today))
             ]

fun testDiff i = Utest.testPP Int.toString
                              ("dateDiff test with difference " ^ (Int.toString i))
